...
//This verifies if the production is done in the days the extractor was booked
if ($data2["exitdate"]>=date("yy-mm-dd")) {
...
$data=mysqli_fetch_array($result);
	//This verifies if the capacity of the metalbin chosen is enough for the kilos the member has produced
	...
	header("Location:profile.php?account=book&date");
}
